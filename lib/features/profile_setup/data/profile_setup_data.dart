/// Static data for Profile Setup — Indian states, districts, soil types & crops
class ProfileSetupData {
  ...
  static const Map<String, List<String>> districts = {
    ...
    'Assam': [
      ...
      'Nalbari', 'Dima Hasao', 'Sivasagar', 'Sonitpur', 'South Salmara-Mankachar',
    ...
    'Himachal Pradesh': [
      ...
      'Kullu', 'Lahaul &amp; Spiti', 'Mandi', 'Shimla', 'Sirmaur (Sirmour)',
      'Solan', 'Una',
    ],
    'Jammu and Kashmir': [
      'Anantnag', 'Bandipore', 'Baramulla', 'Budgam', 'Doda',
      'Ganderbal', 'Jammu', 'Kargil', 'Kathua', 'Kishtwar',
      'Kulgam', 'Kupwara', 'Leh', 'Poonch', 'Pulwama',
    ...
    'Lakshadweep (UT)': [
      'Agatti', 'Amini', 'Androth', 'Bithra', 'Chethlath',
      'Kavaratti', 'Kadmath', 'Kalpeni', 'Kilthan', 'Minicoy',
    ],
    'Madhya Pradesh': [
    ...
    'Punjab': [
      ...
      'Nawanshahr (Shahid Bhagat Singh Nagar)', 'Pathankot', 'Patiala', 'Rupnagar', 'Sahibzada Ajit Singh Nagar (Mohali)',
      'Sangrur', 'Tarn Taran',
    ],
    'Rajasthan': [
    ...
    'Uttar Pradesh': [
      ...
      'Jhansi', 'Kannauj', 'Kanpur Dehat', 'Kanpur Nagar', 'Kanshiram Nagar (Kasganj)',
      'Kaushambi', 'Kushinagar (Padrauna)', 'Lakhimpur - Kheri', 'Lalitpur', 'Lucknow',
      ...
      'Sant Kabir Nagar', 'Shahjahanpur', 'Shamali (Prabuddh Nagar)', 'Shravasti', 'Siddharth Nagar',
    ...
    'West Bengal': [
      ...
      'North 24 Parganas', 'Paschim Medinipur (West Medinipur)', 'Purba Medinipur (East Medinipur)', 'Purulia', 'South 24 Parganas',
      'Uttar Dinajpur (North Dinajpur)',
    ],
  };

  /// Returns districts for a given state, or an empty list.
  static List<String> getDistricts(String state) =>
      districts[state] ?? ['District 1', 'District 2', 'District 3'];

  // ── Soil Types ─────────────────────────────────────────────────────────────
  static const List<Map<String, dynamic>> soilTypes = [
    {
      'name': 'Alluvial Soil',
      'description': 'Best for wheat, rice & sugarcane',
      'icon': '🌾',
      'color': 0xFF8D6E63,
    },
    {
      'name': 'Black (Regur) Soil',
      'description': 'Ideal for cotton & soybean',
      'icon': '⬛',
      'color': 0xFF424242,
    },
    {
      'name': 'Red & Yellow Soil',
      'description': 'Suited for groundnut & tobacco',
      'icon': '🔴',
      'color': 0xFFE64A19,
    },
    {
      'name': 'Laterite Soil',
      'description': 'Good for tea, coffee & cashew',
      'icon': '🟤',
      'color': 0xFFA1887F,
    },
    {
      'name': 'Arid (Desert) Soil',
      'description': 'Suited for bajra & jowar',
      'icon': '🏜️',
      'color': 0xFFFDD835,
    },
    {
      'name': 'Forest Soil',
      'description': 'Ideal for spices & medicinal plants',
      'icon': '🌲',
      'color': 0xFF2E7D32,
    },
    {
    ...
    {
      'name': 'Peaty Soil',
      'description': 'Good for rice & jute',
      'icon': '🌿',
      'color': 0xFF558B2F,
    },
  ];
  ...
  // ── Water Availability ─────────────────────────────────────────────────────
  static const List<String> waterAvailabilityOptions = [
    'Low (Rain-fed only)',
    'Medium (Canal/Well)',
    'High (Borewell/Perennial River)',
  ];
}
