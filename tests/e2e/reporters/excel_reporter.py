...
def generate_excel_report(test_results, output_path):
    """Generates a professional Excel automation test report."""
    ...
    grey_fill = PatternFill(start_color="F2F4F8", end_color="F2F4F8", fill_type="solid")
    ...
    title_cell.value = "KISAN MITRA — E2E TEST EXECUTION REPORT"
    ...
    meta = [
        ...
        ("Test Environment:", "GitHub Pages (Live)"),
        ("Live URL:", os.getenv("BASE_URL", "https://durga1610.github.io/kisan-mitra-web/")),
    ]
    ...
    wb.save(output_path)
    print(f"[ExcelReporter] Report saved successfully to {output_path}")
